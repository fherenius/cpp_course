...
template <typename Data> class Storage
{
  ...
  public:
    ...
    using iterator =
        Iterator<Storage, typename std::vector<Data *>::iterator,
                 Data>; // Typedef for iterator (uses iterator class)
    using reverse_iterator =
        std::reverse_iterator<iterator>; // typedef for reverse iterator
